...
(["1"], ["b","a","8","c","9","d"], false, function($__System) {
...
$__System.register('1', ['2', '3', '5', '4', '8', '9', 'a', 'b', 'c', 'd', '7'], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_) {
      ...
      SystemBuildConfig = _4.default;
    }, function (_5) {
      angular = _5.default;
    }, function (_6) {
      uiRouter = _6.default;
    }, function (_a) {
      angularSanitize = _a.default;
    }, function (_b) {
      angularAnimate = _b.default;
    }, function (_c) {
      toaster = _c.default;
    }, function (_d) {
      ngStrap = _d.default;
...
(function(factory) {
  if (typeof define == 'function' && define.amd)
    define(["angular/bower-angular-animate","angular/bower-angular-sanitize","angular/bower-angular","jirikavi/AngularJS-Toaster","angular-ui-router","angular-strap"], factory);
  else if (typeof module == 'object' && module.exports && typeof require == 'function')
    module.exports = factory(require("angular/bower-angular-animate"), require("angular/bower-angular-sanitize"), require("angular/bower-angular"), require("jirikavi/AngularJS-Toaster"), require("angular-ui-router"), require("angular-strap"));
  else
